...
## 1. Desde un archivo en la computadora o en local ----

# Excel (.xlsx) — con readxl
graduandos2025_excel <- read_xlsx("Datos/2025-Grad-Internet.xlsx")

### CSV ----

graduandos2025_csv <- read.csv(here("Datos","2025-Grad-Internet.csv"))
